...
SART_CG_ITER = 60          # CG/SIRT 最大迭代次数 (v7 是 30, a slope 仅 0.105; v8 #2 改 60 期望 a slope 修复)
...
def main():
    ...
    print("=" * 60)
    t0 = time.time()
    recon_tv = sart_tv_reconstruct(proj_log, n_iter=SART_CG_ITER, tv_weight=0.05)
